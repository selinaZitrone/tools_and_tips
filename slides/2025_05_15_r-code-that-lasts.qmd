...
RStudio offers a lot of settings and options. 

So have a :coffee: and check out `Tools -> Global Options` and all the other buttons.

- [RStudio cheat sheet](https://raw.githubusercontent.com/rstudio/cheatsheets/master/rstudio-ide.pdf) that explains all the buttons
- Update RStudio from time to time to get new settings (`Help -> Check for Updates`)
...
<br>
Or directly use the **absolute path** to the file:
...
- Follow standards for readable code
...
```{r}
#| eval: true
#| code-line-numbers: "|1|2-3|4-5|8-9"
...
# :page_facing_up: Document what you do
...
call `renv::restore()`
- When you create an RStudio project there is a check mark to initialize with `renv`

# Conclusion

## Take aways

- So many tips and rules 😵‍💫
  - Have a look at the lecture website for a checklist for your projects

- Prioritize progress over perfection
- Plan ahead
- In collaborative projects
  - Have common guidelines
  - Communicate your rules (e.g. in the README)
