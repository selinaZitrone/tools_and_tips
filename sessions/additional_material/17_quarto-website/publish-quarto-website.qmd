...
**Already comfortable with Git and GitHub?** Start with [Step 1](#step-1-render-your-website-to-docs), then make sure your project is in a Git repo and pushed to GitHub, and skip ahead to [Step 4: Enable GitHub Pages](#step-4-enable-github-pages).
...
## Step 1: Render your website to `docs` {#step-1-render-your-website-to-docs}
