...
Sampling, bootstrapping, permutation tests, simulations: all give different results each run. Fix the seed so anyone (including future you) reproduces your exact numbers.
...
```python
import numpy as np
# modern NumPy: make a seeded generator, not np.random.seed()
...
![Number of licences used for code and data in BES ecology papers. [Cooper et al. (2026)](https://doi.org/10.1111/2041-210X.70338), *Methods in Ecology and Evolution*](images/2026_07_16_code-sharing/cooper-2026-license.png){fig-alt="Bar chart from Cooper et al. 2026: the licences used in archived code and data, showing that CC is very common."}
...
- [CC BY](https://choosealicense.com/licenses/cc-by-4.0/): reuse for any purpose, as long as you give attribution (a licence, not public domain)
...
- Add a licence file to your repository (e.g. `LICENSE` or `LICENSE.txt`) containing
the licence text  (add your name and year to the copyright notice)
- Automatic ways to add a licence:
...
- If applicable: Add a second licence for the data
- State the licence in the README (e.g. *Code: MIT. Data: CC-BY-4.0*).
...
:::{.callout-note}
Here a note on how to add a licence
:::
...
```markdown
## Citation
Baldauf et al. (2026). Temperature and antibiotic resistance in
...
:::{.callout-note}
Here a good prompt for a data codebook, ready to copy-paste into your AI tool.
:::
