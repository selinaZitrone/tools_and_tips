...
See [website](https://selinazitrone.github.io/tools_and_tips/07_ai_tools.html) for step-by-step guide and more information.
...
- Preset commands starting with `/` 
  ...
  - `/doc`: create a documentation for the code
...
- No definite guidelines, but see examples on [lecture website](https://selinazitrone.github.io/tools_and_tips/07_ai_tools.html)
- **Responsibility**
...
- Check out the [lecture website](https://selinazitrone.github.io/tools_and_tips/07_ai_tools.html) if you want to get started
