...
IDEs (e.g. RStudio, Positron, VS Code) offer auto-formatting tools.

- Use "Format on save" and let the IDE do the job
...
- So many tips and rules 😵‍💫
  - Have a look at the lecture website for a reproducibility checklist
