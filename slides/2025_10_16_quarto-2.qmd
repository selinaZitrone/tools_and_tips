...
- Main focus R and RStudio
- Keep in mind: The workflow is the same with other languages and other IDEs
- Download a quarto demo project from [Github](https://github.com/selinaZitrone/quarto_demo)
  - Contains some simple and more complex Quarto examples for different document types and programming languages

# Let's get started! {background-image="images/2025_10_16_quarto-2/penguins_jumping.png" background-size="cover"}

::: aside
<small style="position: absolute; bottom: 0; left: 0; margin: 10px;">
...
## Creating a reproducible document step by step
...
-   Code chunks can be run like "normal" code
...
```cmd
quarto render my_report_chinstrap.qmd -P species:Chinstrap
```
