...
- Main focus R and RStudio, but same workflow with other languages and other IDEs
...
Check out the [Quarto website](https://quarto.org/) for more information and tutorials
...
```cmd
quarto render my_report.qmd --output "report_chinstrap.pdf" -P species:Chinstrap
```
...
- Check out the demo project and the links on the lecture website
